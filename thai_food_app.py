...
with col1:
    ...
    # Iterate through categories and display menu items
    for category, item_codes in MENU_CATEGORIES.items():
        ...
        for code in sorted_codes:
            ...
            with menu_col3:
                ...
                # Key must be unique for each button instance
                st.button("Add", key=f"add_{code}", on_click=add_to_cart, args=(code, item_name, price))
